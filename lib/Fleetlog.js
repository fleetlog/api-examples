...
Fleetlog.prototype = {
  ...
  getTrips: function (queryParams, callback) {
    ...
    this._fleetlogRequest("GET", '/v2/trips' + _queryString, null, function (error, results) {
      callback(error, results != null ? results.data : []);
    });
  },
  ...
  getCoordinates: function (queryParams, callback) {
    ...
    this._fleetlogRequest("GET", '/v2/coordinates' + _queryString, null, function (error, results) {
      callback(error, results != null ? results.data : []);
    });
  },
  ...
  getCoordinates: function (tripId, queryParams, callback) {
    ...
    this._fleetlogRequest("GET", '/v2/trips'+ tripId +'coordinates' + _queryString, null, function (error, results) {
      callback(error, results != null ? results.data : []);
    });
  },
